...
const WalkthroughScreen = (props) => {
  ...
  _renderNextButton = () => {
    return <Text style={styles.button}>{IMLocalized('Suivant')}</Text>;
  };

  _renderSkipButton = () => {
    return <Text style={styles.button}>{IMLocalized('Passer')}</Text>;
  };

  _renderDoneButton = () => {
    return <Text style={styles.button}>{IMLocalized('Terminer')}</Text>;
  };

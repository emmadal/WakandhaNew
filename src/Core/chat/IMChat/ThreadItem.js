                ...
                <View style={{ flexDirection: 'row' }}>
                  <View style={styles.timerContainer}>
                    <Text style={styles.textTimer}>
                      {item && item.created && item.created.seconds
                        ? formateDate(item.created.seconds)
                        : ''}
                    </Text>
                  </View>
        ...
        {inBound && (
          <View style={styles.receiveItemContainer}>
            {item.url !== null && item.url !== '' && (
              <TouchableOpacity
                activeOpacity={0.9}
                style={[styles.itemContent, styles.receiveItemContent]}
                onPress={didPressMediaChat}>
                <ThreadMediaItem
                  updateItemImagePath={updateItemImagePath}
                  videoRef={videoRef}
            ...
            {!item.url && (
              <View style={styles.theirMessageBubbleContainerView}>
                ...
                <View style={{ flexDirection: 'row' }}>
                  <View style={styles.receiveItemNameContent}>
                    <Text
                      style={[styles.sendTextMessage, styles.rightTextMessage]}>
                      {item.senderFirstName + ' ' + item.senderLastName}
                    </Text>
                  </View>
                  <View style={styles.timerContainer}>

...
function IMChat(props) {
  ...
  return (
    <SafeAreaView style={styles.personalChatContainer}>
      ...
      />
      <ActionSheet
        title={IMLocalized('Paramètres du groupe')}
        options={[
          IMLocalized('Renommer le groupe'),
          IMLocalized('Quitter le groupe'),
          IMLocalized('Annuler'),
        ]}
        cancelButtonIndex={2}
      ...
      <DialogInput
        ...
        title={IMLocalized('Changer le nom')}
      ...
      <ActionSheet
        ...
        options={[
          ...
          IMLocalized('Ouvrir la bibliothèque de photos'),
          IMLocalized('Annuler'),
        ]}
        cancelButtonIndex={2}
      ...
      <ActionSheet
        ...
        options={[
          IMLocalized("Bloquer l'utilisateur"),
          IMLocalized("Signaler l'utilisateur"),
          IMLocalized('Annuler'),
        ]}
        cancelButtonIndex={2}
      ...
      <ActionSheet
        ...
        title={IMLocalized('Actions')}
        options={[IMLocalized('Répondre'), IMLocalized('Annuler')]}
        cancelButtonIndex={1}

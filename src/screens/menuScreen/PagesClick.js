...
export default function PageClick({ navigation }) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerMain}>
        ...
        <FontAwesome name="search" size={30} color="#DFBA35" />
      </View>

      <ScrollView>
        <Text style={styles.pagesMain}>Pages</Text>

        <View style={{ marginLeft: wp('3%') }}>
          <TouchableWithoutFeedback
            onPress={() => navigation.navigate('NewPageCategory')}>
            <View>
          ...
          <View>
            <View style={styles.container2}>
              ...
              <Text style={styles.invitations}> Pages aimés</Text>
            </View>
          </View>

          <TouchableWithoutFeedback
            onPress={() => navigation.navigate('UserPages')}>
            <View>
              <View style={styles.container2}>
                <AntDesign name="like1" size={28} color="#DFBA35" />
                <Text style={styles.invitations}> Vos pages</Text>
              </View>
            </View>
          </TouchableWithoutFeedback>
        </View>

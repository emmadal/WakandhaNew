...
import { getVariations } from '../../modules/product/service';
import {
  attributeSelector,
  dataRatingSelector,
...
import { getSingleData, defaultPropsData } from '../../hoc/single-data';
...
import { fetchVendorDetail } from '../../modules/vendor/actions';

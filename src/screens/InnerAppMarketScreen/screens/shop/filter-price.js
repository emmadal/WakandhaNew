...
import MultiSlider from '../../containers/MultiSlider';
import CustomMarker from '../../containers/MultiSlider/CustomMarker';
...
class FilterPrice extends PureComponent {
  constructor(props, context) {
    ...
    this.state = {
      values: [parseInt(min_price, 10) * rate, parseInt(max_price, 10) * rate],
      rate: rate,
    };
  }
  ...
  clearAll = () => {
    ...
    this.setState({
      values: [parseInt(min, 10), parseInt(max, 10)],
    });
  };

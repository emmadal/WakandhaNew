...
import { sendContactVendorId } from '../../../modules/vendor/service';
import { validatorContact } from '../../../modules/vendor/validator';
...
export default connect(mapStateToProps)(withTranslation()(ContactStore));

...
const users = [
  {
    ...
    last_name: '',
    avatar_url:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTSg35HXopiSTcbvsKPZ2pscOGxiP7S90TesNXkkceARcv8TLQK5A&s',
  },
  {
    id: '2',
      ...
      <ThemeConsumer>
        {({ theme }) => (
          <Container style={styles.container}>
            <Text h4 medium style={styles.textCount}>
              {store && store.follows} Follows
            </Text>
            <FlatList

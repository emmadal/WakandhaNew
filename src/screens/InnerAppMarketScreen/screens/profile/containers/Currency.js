...
import { changeCurrency } from '../../../modules/common/actions';
    ...
    return (
      <View style={styles.right}>
        ...
        <Modal
          visible={visible}
          setModalVisible={() =>
            this.setState({ visible: false, currency: currency })
          }
          topRightElement={
            <Button
...
export default compose(withTranslation(), connect(mapStateToProps))(Currency);

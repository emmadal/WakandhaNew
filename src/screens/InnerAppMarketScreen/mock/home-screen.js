import { productListTypes, productListLayout } from '../config/product';
...
export const home1 = [
  {
    ...
    data: [
      {
        image:
          'https://cdn.rnlab.io/uploads/2019/08/06022038/slideshow1%403x.jpg',
      ...
      {
        image:
          'https://cdn.rnlab.io/uploads/2019/08/06022045/slideshow3%403x.jpg',
        heading: { text: { en: '60% OFF', ar: '60 ٪ من' }, color: '#e60023' },
        sub: { text: { en: 'New', ar: 'الجديد' }, color: '#000' },
        title: { text: { en: 'Sweater', ar: 'سترة' }, color: '#000' },
      },
      {
        image:
          'https://cdn.rnlab.io/uploads/2019/08/06022032/slideshow2%403x.jpg',
  ...
  },
  {
    ...
    data: [
      {
        image:
          'https://cdn.rnlab.io/uploads/2019/08/06013343/bannerBag%403x.png',
        action: '',
        width: 188,
        height: 270,
      ...
      {
        image:
          'https://cdn.rnlab.io/uploads/2019/08/06013338/bannerFlashSale%403x.png',
        action: '',
        width: 188,
        height: 270,
        style: { borderRadius: 0 },

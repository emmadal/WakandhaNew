...
class GetStartSwiper extends React.Component {
  ...
  render() {
    ...
    const data = [
      {
        image: require('../assets/images/getting-start/get-start-1.png'),
        title: t('getting:text_title_1'),
        subtitle: t('getting:text_subtitle_1'),
      },
      {
        image: require('../assets/images/getting-start/get-start-2.png'),
        title: t('getting:text_title_2'),
        subtitle: t('getting:text_subtitle_2'),
      },
      {
        image: require('../assets/images/getting-start/get-start-3.png'),

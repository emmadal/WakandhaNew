...
} from '../../../mock/product-attributes';

import { productAttributeDefault } from '../../../mock/product-attributes-default';
import {
  productVariations1,
  productVariations2,
  productVariations3,
} from '../../../mock/variations';
...
describe('Prepare product attribute', () => {
  ...
  it('should handle attribute default', () => {
    ...
    const result = prepareProductAttributeDefault(
      productAttribute,
      attributeInput,
    );
    ...
    const expectVariations = [
      {
        attributes: [
          ...
          },
          {
            ...
            key: 'pa_image',
            value:
              'https://cdn.rnlab.io/uploads/2019/06/28100437/j9-150x150.jpg',
          },
        ],
      },
    ];
...
describe('Filter product variations', () => {
  it('Case 1', () => {
    const meta_data = fromJS([
      { id: 4, name: 'M', slug: 'm', key: 'pa_size', value: '' },
    ]);

    const productVariations = prepareProductVariations(
      fromJS(productVariations3),
      attributeInput,
    );

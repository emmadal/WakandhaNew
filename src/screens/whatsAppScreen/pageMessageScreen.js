...
**/
export default class PagesMessageScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isVisible: false,
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
          ...
          <View>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 200,
                backgroundColor:
                  onlinestatus == 'online' ? '#71c55d' : '#d3d3d3',
        ...
        {/*END HEADER */}
        <ImageBackground
          source={require('../../../assets/images/william.jpg')}
          ...
          <ScrollView
            ...
            <View
              ...
              {/* <View
                ...
                <Text style={{ color: '#ffbf00', alignSelf: 'center' }}>
                  ₦{' '}
                </Text>

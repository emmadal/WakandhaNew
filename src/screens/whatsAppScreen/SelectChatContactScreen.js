...
/**
This is the screen where a user selects the contact he/she wants to chat/exchange messages with
**/

export default class SelectChatContactScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isVisible: false,

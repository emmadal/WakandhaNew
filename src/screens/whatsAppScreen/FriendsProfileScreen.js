...
/**
This is used to display user's friends/contacts profile screen
**/
export default class FriendsProfileScreen extends Component {
  render() {
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                <Image
                  source={require('../../../assets/icons/whtasappicon/arrow_back.png')}
                  style={{ height: 30, width: 30, tintColor: 'white' }}
                />
              </TouchableOpacity>
              {/*<Text style={{textAlign:'center',alignSelf:'center',fontSize:22,color:'white',fontWeight:'bold'}}>PROFILE</Text>*/}
              <TouchableOpacity>
                <Image
                  source={require('../../../assets/icons/whtasappicon/more.png')}
                  style={{ height: 30, width: 30, tintColor: 'white' }}
                />
              </TouchableOpacity>
            </View>
